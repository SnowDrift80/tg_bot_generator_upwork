...
async def create_scaffold(update: Update, context: ContextTypes.DEFAULT_TYPE, assistant):
    ...
    Response structure: The the lecture must consist of four to five parent-chapters and at least twenty sub-chapters in total.
    Group sub-chapters by topic and create a parent chapter for each group.
    ...
    for line in list_of_lines:
        ...
        In general context to the topic, write an academic text expanding on the following subchapter title: \"{line}\"
        """
        message = OPENAI_CLIENT.beta.threads.messages.create(
            thread_id=oai_thread_id,
            role="user",
