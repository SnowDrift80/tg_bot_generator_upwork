...
from utils import SharedUtils, DocumentExport
...
class LectureDriver:
    ...
    async def create_lecture(self, update: Update, context: CallbackContext):
        chapter_titles = {}
        ...
        try:
            ...
            language = await SharedUtils.identify_language(instruction_text)
